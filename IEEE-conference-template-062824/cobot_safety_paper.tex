...
Current collision detection methods can be broadly categorized into three families. Hardware-based approaches employ certain types of force-torque sensors or six degree of freedom force sensors for direct measurement of contact forces~\cite{wang2025sixdof}. In comparison, observer-based approaches use mathematical state estimators, including the Extended State Observer, for estimating the external forces based on joint measurements without any requirement of any additional sensors~\cite{tonti2024eso}. Data-driven approaches involve training classifiers using the sensor data through application of signal transformations, such as wavelet decomposition~\cite{niu2024wavelet} or multivariate fusion~\cite{fang2024multivariate} to improve discriminability. More recently, digital twin environments have been proposed to simulate collision scenarios for safer algorithm development~\cite{an2024digitaltwin} and deep learning has been integrated with zero-force control strategies~\cite{zhao2025zeroforce}.
