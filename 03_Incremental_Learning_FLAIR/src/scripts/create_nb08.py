...
RESULTS_DIR  = os.path.abspath(os.path.join(PROJECT_ROOT, '../output/experiments/exp06_der_sa'))
...
# Write notebook
out_path = os.path.abspath(os.path.join(os.path.dirname(__file__), '../notebooks/08_der_sa_experiment.ipynb'))
