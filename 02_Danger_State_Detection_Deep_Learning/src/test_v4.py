...
candidate_paths = [
    os.path.join(script_dir, "../assets/data/DASIG"),
    os.path.join(script_dir, "../../data/multiphysio_hrc/DASIG"),
    "data/multiphysio_hrc/DASIG",
    "assets/data/DASIG"
]
dasig_dir = next((p for p in candidate_paths if os.path.exists(p)), candidate_paths[0])
all_trials = load_all_trials(dasig_dir, generate_labels=True, verbose=False)
