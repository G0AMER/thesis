...
\authormark{A. Gargouri et al.}

\articletype{RESEARCH ARTICLE}

\jnlPage{1}{11}
\jyear{2026}
\jdoi{10.1017/S02635747xxxxxxx}

\title{Danger-State Detection in Human-Robot Collaboration Using Deep Learning}

\author[1,2]{Ameur Gargouri}
\address[1]{ATISP Lab, ENET'Com, University of Sfax, Sfax, Tunisia}

\author[2]{Mohamed Karray\hyperlink{corr}{*}}
\address[2]{ESME Research Lab, Ivry-sur-Seine, France}

\author[1]{Mohamed Ksantini}

\address{\hypertarget{corr}{*}Corresponding author. \email{mohamed.karray@esme.fr}}
...
\begin{con}
    ...
    All authors contributed to the study conception and design. Ameur Gargouri developed the methodology, implemented the software pipeline, performed data processing and experimental evaluations, and wrote the original draft of the manuscript. Mohamed Karray and Mohamed Ksantini supervised the research, guided the methodology, contributed to the analysis of results, and critically reviewed and revised the manuscript. All authors read and approved the final manuscript.
