...
\shorttitle{Danger-State Detection in Human-Robot Collaboration Using Deep Learning}
\shortauthors{A. Gargouri et al.}

% Main title
\title [mode = title]{Danger-State Detection in Human-Robot Collaboration Using Deep Learning}

% First author
\author[1,2]{Ameur Gargouri}
\ead{ameur.gargouri.doc@enetcom.usf.tn}
%\credit{Conceptualization, Methodology, Software, Data curation, Formal analysis, Validation, Writing - Original Draft}

% Second author (Corresponding)
\author[2]{Mohamed Karray}
\cormark[1]
\ead{mohamed.karray@esme.fr}
%\credit{Conceptualization, Methodology, Supervision, Resources, Writing - Review \& Editing}
...
% Affiliations
\affiliation[1]{organization={ATISP Lab, ENET'Com, University of Sfax},
    city={Sfax},
    country={Tunisia}}

\affiliation[2]{organization={ESME Research Lab},
    city={Ivry-sur-Seine},
    country={France}}
...
\begin{table*}[width=\textwidth,cols=6,pos=t]
    \caption{Benchmark results with temporal post-processing ($\tau = 0.77$, median-filtered)}\label{tab:results}
    \begin{tabular*}{\tblwidth}{@{} C L C C C C @{}}
        \toprule
...
\begin{table}[width=\linewidth,cols=5,pos=h]
    \caption{Effect of temporal post-processing on TCN predictions}\label{tab:postprocess}
