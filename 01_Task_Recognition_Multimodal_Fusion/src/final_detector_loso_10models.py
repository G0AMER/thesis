...
if (WORK_DIR / 'output' / 'research_outputs' / 'fusion' / 'v1_fusion' / 'fusion_dataset.csv').exists():
    DATASET = WORK_DIR / 'output' / 'research_outputs' / 'fusion' / 'v1_fusion' / 'fusion_dataset.csv'
    OUT_ROOT = WORK_DIR / 'output' / 'research_outputs' / 'fusion_training' / 'final_detector_loso_10models'
else:
    DATASET = Path('/home/g0amer/Desktop/thesis/01_Task_Recognition_Multimodal_Fusion/output/research_outputs/fusion/v1_fusion/fusion_dataset.csv')
    OUT_ROOT = Path('/home/g0amer/Desktop/thesis/01_Task_Recognition_Multimodal_Fusion/output/research_outputs/fusion_training/final_detector_loso_10models')
