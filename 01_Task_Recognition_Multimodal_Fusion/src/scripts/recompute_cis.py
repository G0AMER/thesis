...
WORK_DIR = SCRIPT_DIR.parents[1]
BASE = WORK_DIR / 'output' / 'research_outputs' / 'fusion_training' / 'v2_full_benchmark'
if not BASE.exists():
...
try:
    ...
    print(f'Run: pip install -r {WORK_DIR.parent}/03_Incremental_Learning_FLAIR/src/requirements.txt')
    raise
