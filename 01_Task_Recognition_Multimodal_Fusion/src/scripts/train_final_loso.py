...
def main():
    ...
    default_dataset = work_dir / 'output' / 'research_outputs' / 'fusion' / 'v1_fusion' / 'fusion_dataset.csv'
    default_out = work_dir / 'output' / 'research_outputs' / 'fusion_training' / 'final_detector'
